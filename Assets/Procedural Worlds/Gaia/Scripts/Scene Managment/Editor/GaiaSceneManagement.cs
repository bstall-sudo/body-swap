...
namespace Gaia
{
    ...
    public static class GaiaSceneManagement
    {
        ...
        {
            var telArea = t.gameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationArea>();

            if (telArea == null)
            {
                telArea = t.gameObject.AddComponent<UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationArea>();
            }
